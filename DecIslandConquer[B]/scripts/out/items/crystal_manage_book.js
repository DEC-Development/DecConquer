    ...
    static crystal_manage_book_create(player, block_l) {
        ...
        index.show(player).then(t => {
            if (t.formValues[0] == 0) {
                ...
                let loc = block_l;
                loc.y += 1;
                if (!SpawnPoint.set(String(t.formValues[1]), loc, player.dimension, t.formValues[2], Number(t.formValues[3]))) {
